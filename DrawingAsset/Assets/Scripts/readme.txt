...
The code architecture is based off of MVVM (google is your friend here)
To describe it simply:
M = model, this is the data model. It should be as dumb as possible, and only hold data
V = view, this is odd in Unity as the "view" is the scene itself
VM = view model,
...
6. Set the "pivot" of the RectTranform to (0,0)
...
* make sure the RectTransform has a pivot of (0,0)
